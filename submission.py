...
Original file is located at
    https://colab.research.google.com/drive/1Kq4-09QQAq8HGi9_H1mqxKuA82_iK1vv
...
def main(input_dir, output_dir):
    ...
    embedding_path = os.path.join(input_dir, "argument_embeddings.csv")
    arguments = pd.read_csv(embedding_path)

    all_results = get_results(arguments)

    output_path = os.path.join(output_dir, "results.jsonl")
    save_results_to_jsonl(all_results, output_path)
